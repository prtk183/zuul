...
public class ATMServiceImpl implements ATMService {
 ...
 public  Logger log = Logger.getLogger(ATMServiceImpl.class.getName());
   ...
   * @return atm
   * @see com.szuul.service.ATMService#createATM(com.szuul.wrappers.WrapperATMCreate)
   */
  @Override
   ...
   * @see com.szuul.service.ATMService#addMoneyFromBank(com.szuul.wrappers.WrapperATMAddMoneyToATM)
   */
  @Override
   ...
   * @see com.szuul.service.ATMService#withdrawMoney(com.szuul.wrappers.WrapperATMWithdraw)
   */
  @Override
