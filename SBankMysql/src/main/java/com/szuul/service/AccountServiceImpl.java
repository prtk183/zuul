...
public class AccountServiceImpl implements AccountService {
 ...
 private  Environment environment;
   ...
   * creating an account.
   * 
   * @see com.szuul.service.AccountService#createAccount(com.szuul.wrappers.CreateAccountWrapper)
   */
  @Override
  @Transactional
...
else
{
   ...
   * 
   * @see com.szuul.service.AccountService#getAccountDetails()
   */
  @Override
 ...
 if( object.getAmount()!=null && object.getBankId()!=null && object.getCustomerId()!=null)
{
   ...
   * 
   * @see com.szuul.service.AccountService#withdrawMoney(com.szuul.wrappers.WrapperAccountDeposite)
   */
  @Override
  @Transactional
